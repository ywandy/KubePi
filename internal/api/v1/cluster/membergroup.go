...
func (h *Handler) UpdateClusterMemberGroup() iris.Handler {
...
func (h *Handler) GetClusterMemberGroup() iris.Handler {
	return func(ctx *context.Context) {
		name := ctx.Params().GetString("name")
...
func (h *Handler) ListClusterMembersGroup() iris.Handler {
	return func(ctx *context.Context) {
		name := ctx.Params().GetString("name")
...
func (h *Handler) CreateClusterMemberGroup() iris.Handler {
	return func(ctx *context.Context) {
		name := ctx.Params().GetString("name")
		var req Member
		err := ctx.ReadJSON(&req)
		...
		binding := v1Cluster.Binding{
			...
			Metadata: v1.Metadata{
				Name: fmt.Sprintf("g-%s-%s-cluster-binding", name, req.Name),
			},
			UserRef:    req.Name,
			ClusterRef: name,
		}
...
func (h *Handler) DeleteClusterMemberGroup() iris.Handler {
	return func(ctx *context.Context) {
		name := ctx.Params().GetString("name")
